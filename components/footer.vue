<template>
  <div class="mx-auto max-w-7xl px-6">
    <footer class="text-center text-gray-600 lg:text-left">
    ...
    <div
      class="flex items-center justify-center border-t-2 border-gray-100 p-6 lg:justify-between"
    >
      ...
      <div class="mr-12 hidden lg:block">
        <span>&copy; {{ year }}</span>
        <a class="font-semibold text-gray-600" href="https://medex-lab.it/">
          Medex Lab
        </a>
      </div>
    </div>
